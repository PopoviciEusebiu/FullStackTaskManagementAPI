...
class UpdateGroupTask extends React.Component {
    constructor(props) {
        super(props);
        const { task } = props;
        this.state = {
    ...
    onSubmitFunction(event) {
        ...
        this.authenticatedAxios().put(`/group/${groupId}/updateTask/${this.state.id}/fromUser/${userId}`, updatedTask)
            .then(() => {
                this.setState({
                    updateSuccess: true,
                    errorMessage: ""
...
export default withRouter(UpdateGroupTask);
